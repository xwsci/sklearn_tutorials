...
#Define the model with and without shrinkage
lda1=LinearDiscriminantAnalysis(solver='lsqr',shrinkage=None)
lda2=LinearDiscriminantAnalysis(solver='lsqr',shrinkage='auto')

#Train model using different sizes of sample and then output the prediction scores
lda1_score=[]
lda2_score=[]
sample_number=[]
...
#Plot the prediction scores vs sample size
